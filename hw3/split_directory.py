...
baseFolder = './CUB_200_2011/images'
...
shutil.copytree(baseFolder, './CUB_200_2011/train')
shutil.copytree(baseFolder, './CUB_200_2011/validation')

for path, subdirs, files in os.walk('./CUB_200_2011/train'):
    for name in files:
        if name not in paths_for_train:
            os.remove(os.path.join(path, name))

for path, subdirs, files in os.walk('./CUB_200_2011/validation'):
    for name in files:
